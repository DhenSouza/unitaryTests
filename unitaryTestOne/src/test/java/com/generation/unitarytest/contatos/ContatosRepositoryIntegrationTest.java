package com.generation.unitarytest.contatos;
...
import com.generation.unitarytest.repositories.ContatoRepository;
...
public class ContatosRepositoryIntegrationTest {
	...
	@Before
	public void start() {
		contato = new ContatoEntity("Denilson", "011y", "9xxxxxxx9");
	}
	...
	public void salvarComTelNulo() throws Exception {
		esperadaExcecao.expect(javax.validation.ConstraintViolationException.class);
